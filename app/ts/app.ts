...
const cliente1: Cliente = new Cliente("pedro", "111.111.111-11");  //m
const cliente2: Cliente = new Cliente("joao", "222.222.222-22");  //d
const cliente3: Cliente = new Cliente("maria", "333.333.333-33");  //a
